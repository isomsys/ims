...
for (var i=0; i<x.length; i++)
  ...
  $(function() {
    ...
    <script> 
 function Color123(bid,color){
   var property=document.getElementById(bid);

property.style.backgroundColor=color;
//var valcell = cells.split(",");
//for(var i=0;i<valcell.length;i++){
 // var property1=document.getElementById("valcell[i]");
 //document.write(k);   
//property1.style.backgroundColor="red";
//}
}
 </script>
                 ...
                 <div>
                  <a href="<?php echo site_url('site')?>"><button style="position:absolute;top:1800px;text-align: left;width:125px;left:750px;"type="button" class="btn btn-info">Home</button></a>
