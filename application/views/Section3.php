  ...
  $(function() {
    ...
    $( "#datepicker" ).datepicker();
                 ...
                 <div>
                     ...
                     <input type ="submit" style="position:absolute;top:1800px;text-align: left;width:125px;left:600px;"id="btnimp" value="save the form" onclick="getColor();" class="btn btn-danger">
                </div>
